    ...
    // Routes
    {
        ...
        children: [
            ...
            },
            {
                ...
                name: 'AdminProducts',
                meta: { title: 'Product Management', permissions: ['view-products'] }
            },
            {
                path: 'categories',
                component: () => import('./components/admin/products/AdminCategories.vue'),
                name: 'AdminCategories',
                meta: { title: 'Category Management', permissions: ['manage-categories'] }
            },
            {
                path: 'stock-ledger',
                component: () => import('./components/admin/stock/AdminStockLedger.vue'),
                name: 'AdminStockLedger',
                meta: { title: 'Stock Ledger', permissions: ['view-stock-ledger'] }
            },
            {
                path: 'purchases',
                component: () => import('./components/admin/purchase/AdminPurchases.vue'),
                name: 'AdminPurchases',
                meta: { title: 'Supplier Invoices', permissions: ['view-purchases'] }
            },
            {
                path: 'suppliers',
                component: () => import('./components/admin/master/AdminSuppliers.vue'),
                name: 'AdminSuppliers',
                meta: { title: 'Supplier Management', permissions: ['manage-suppliers'] }
            },
            {
                path: 'customers',
